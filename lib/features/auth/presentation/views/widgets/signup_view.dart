...
class _SignupViewState extends State<SignupView> {
  ...
  void _submitForm() {
    if (_formKey.currentState!.validate()) {
      displayMessage('Sign Up Successful', false);
          ...
          SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                const CustomText(text: 'Sign Up to Continue', color: Colors.white, size: 18),
                ...
                Form(
                  ...
                  child: Column(
                    children: [
                      ...
                      AutoHideKeyboard(
                        child: TextFormField(
                          ...
                          validator: (value) {
                            ...
                            if (value.length < 10) {
                              return 'Please enter a valid address (address must be at least 10 characters)';
                            }
                            return null;
                          },
                          style: const TextStyle(color: Colors.white),
                      ...
                      Row(
                        children: [
                          const CustomText(text: "Already Have an Account ?", size: 20),
                          TextBtn(
                            title: 'Sign In',
